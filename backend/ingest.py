...
async def ingest_document(
    ...
    print(f"  Initialized Vertex AI embedding model: {model_name}")
    ...
    # Vectorize and save chunks in batches (max 250 per request)
    BATCH_SIZE = 100
    for i in range(0, len(chunks), BATCH_SIZE):
        batch = chunks[i:i + BATCH_SIZE]
        print(f"  Processing embedding batch {i // BATCH_SIZE + 1} ({len(batch)} chunks)...")
        
        # Call Vertex AI for the batch
